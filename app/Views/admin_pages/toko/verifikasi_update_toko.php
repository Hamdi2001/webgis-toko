                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <div class="btn mb-1">
                                                        <form action="<?= base_url(); ?>/toko/saveDataUpdate/<?= $tk['id_toko']; ?>" method="post" class="d-inline">
                                                            <button type="submit" class="btn btn-success" name="status_toko" value="1"><i class="fas fa-check"></i></button>
                                                        </form>
                                                        
                                                    <form action="<?= base_url(); ?>/toko/rejectDataUpdate/<?= $tk['id_toko']; ?>" method="post" class="d-inline">
                                                            <button type="submit" class="btn btn-danger" name="status_toko" value="3"><i class="fas fa-times"></i></button>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
